...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(log_dir / 'delete_data.log'),
...
def main():
    """Main function to delete all bronze and silver data."""
    logger.info("🚀 Starting Bronze and Silver Data Deletion")
    logger.info("=" * 60)
    ...
    # Confirm deletion
    logger.info("\n⚠️  WARNING: This will delete ALL data from bronze and silver layers!")
    ...
    logger.info("\n🎉 Bronze and Silver Data Deletion Completed!")
    logger.info("=" * 60)
    logger.info("All bronze and silver layer data has been removed.")
